...
Namespace Scaffolding.CustomFilter.ViewModels
    ...
    Partial Public Class IssueContextViewModel
        ...
        Protected Overrides Function CreateModules() As IssueContextModuleDescription()
            Return New IssueContextModuleDescription() { New IssueContextModuleDescription("Issues", "IssueCollectionView", TablesGroup, GetPeekCollectionViewModelFactory(Function(x) x.Issues))}
        End Function
