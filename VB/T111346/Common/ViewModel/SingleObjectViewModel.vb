...
Namespace Global.T111346.Common.ViewModel
    ...
    Public MustInherit Class SingleObjectViewModelBase(Of TEntity As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
        ...
        ''' </summary>
        Public Overridable ReadOnly Property EntityDisplayName As String
            Get
        ...
        Public Overridable Sub Delete()
            If MessageBoxService.ShowMessage(String.Format(CommonResources.Confirmation_Delete, EntityDisplayName), GetConfirmationMessageTitle(), MessageButton.YesNo) <> MessageResult.Yes Then
                Return
            End If
            Try
        ...
        Public Function IsNew() As Boolean
            Return Entity IsNot Nothing AndAlso GetState() = EntityState.Added
        End Function
        ...
        Protected Overridable Function GetTitle() As String
            Return (EntityDisplayName + " - " + Convert.ToString(If(getEntityDisplayNameFunc IsNot Nothing, getEntityDisplayNameFunc(Entity), PrimaryKey))).Split(New String() {"" + vbCr + "", "" + vbLf + ""}, StringSplitOptions.RemoveEmptyEntries).FirstOrDefault()
        End Function
        ...
        Protected Overridable Function CanCreateNewEntity() As Boolean
            ...
            If Not IsNew() Then
                Return True
            End If
            Dim message As String = String.Format(CommonResources.Confirmation_SaveParent, EntityDisplayName)
