...
Namespace Scaffolding.CustomFilter.ViewModels
    Partial Public Class IssueCollectionViewModel
        ...
        Private Shared ReadOnly filters_Renamed As IEnumerable(Of FilterExpressionInfo(Of Issue)) = New FilterExpressionInfo(Of Issue)() { _
            New FilterExpressionInfo(Of Issue) ("All", Function(x) True), _
            New FilterExpressionInfo(Of Issue) ("For support", Function(x) x.IssueType = IssueType.Question), _
            New FilterExpressionInfo(Of Issue) ("For developers", Function(x) x.IssueType = IssueType.Bug OrElse x.IssueType = IssueType.Suggestion) _
        }
