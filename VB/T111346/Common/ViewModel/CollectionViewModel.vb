...
Namespace Global.T111346.Common.ViewModel
    ...
    Public MustInherit Class CollectionViewModelBase(Of TEntity As Class, TProjection As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
        ...
        Public Overridable Sub Delete(ByVal projectionEntity As TProjection)
            If MessageBoxService.ShowMessage(String.Format(CommonResources.Confirmation_Delete, EntityDisplayName), CommonResources.Confirmation_Caption, MessageButton.YesNo) <> MessageResult.Yes Then
                Return
            End If
            Try
