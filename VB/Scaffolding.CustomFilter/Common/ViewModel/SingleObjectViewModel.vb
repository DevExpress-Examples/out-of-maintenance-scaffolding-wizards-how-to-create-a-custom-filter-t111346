...
Namespace Common.ViewModel
    ...
    Partial Public MustInherit Class SingleObjectViewModel(Of TEntity As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
        ...
        End Sub
    End Class
    Public Class SingleObjectViewModelState(Of TPrimaryKey)
        Public Property Key As TPrimaryKey
    ...
    Public MustInherit Class SingleObjectViewModelBase(Of TEntity As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
        Implements ISupportParameter, IDocumentContent, ISupportLogicalLayout(Of SingleObjectViewModelState(Of TPrimaryKey)), ISingleObjectViewModel(Of TEntity, TPrimaryKey)
        ...
        Private ReadOnly Property CanSerialize As Boolean Implements ISupportLogicalLayout.CanSerialize
            ...
            End Get
        End Property
        Private Function SaveState() As SingleObjectViewModelState(Of TPrimaryKey) Implements ISupportLogicalLayout(Of SingleObjectViewModelState(Of TPrimaryKey)).SaveState
            Return New SingleObjectViewModelState(Of TPrimaryKey)() With {.Key = PrimaryKey, .Title = GetTitle(False)}
        End Function
        Private Sub RestoreState(ByVal state As SingleObjectViewModelState(Of TPrimaryKey)) Implements ISupportLogicalLayout(Of SingleObjectViewModelState(Of TPrimaryKey)).RestoreState
